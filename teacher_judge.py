...
res = session.get("http://10.200.21.61:7001/ieas2.1/xspj/Fxpj_fy", allow_redirects=False)
...
def judge_item(teacher):
    ...
    r = session.post("http://10.200.21.61:7001/ieas2.1/xspj/toAddPjjs", data=form_data)
    ...
    r2 = session.post('http://10.200.21.61:7001/ieas2.1/xspj/saveXspj', data=form_data2)
